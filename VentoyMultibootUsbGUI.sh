...
_out=$(yad --center --image="drive-removable-media-usb-pendrive" --window-icon="drive-removable-media-usb-pendrive" --title="Multiboot USB with ventoy" --form --field="Device ":CB "$REMOVABLE_DRIVES" --field="Set a name ":CBE --width=500 --height=100)
